        ...
        <div className="container-fluid px-4">
            ...
            <div className="row min-vh-100 align-items-center" style={{ paddingTop: '100px' }}>
                ...
                <div className="col-md-7 d-none d-md-block text-center">
                    <img src="/assets/tekundu.png" alt="Taekwondo" className="img-fluid shadow-lg" style={{ transition: 'box-shadow 0.3s ease-in-out', maxWidth: '90%' }} onMouseEnter={(e) => e.target.style.boxShadow = '0 0 20px rgba(0,0,0,0.3)'} onMouseLeave={(e) => e.target.style.boxShadow = '0 0 10px rgba(0,0,0,0.1)'} />
                </div>
            </div>
